      ...
      <div className="max-w-3xl mx-auto px-6 py-12">
        ...
        <section className="mb-8">
          ...
          <p className="text-gray-600 leading-relaxed mt-2">
            ...
            Contact : <a href="mailto:[adresse retirée]" className="text-green-600 hover:underline">[adresse retirée]</a>
          </p>
        </section>
        ...
        <section className="mb-8">
          ...
          <p className="text-gray-600 leading-relaxed mt-2">
            Pour signaler un contenu : <a href="mailto:[adresse retirée]" className="text-green-600 hover:underline">[adresse retirée]</a>
          </p>
        </section>
